...
trap_function_exit_middle() { env_delete_tmp_batch_script_fifo; rm -f "/tmp/batch_script_in_progress"; env_stop_sudo; unset SUDOPASSWORD; unset USE_PASSWORD; env_deactivating_caffeinate }
"${ENV_SET_TRAP_SIG[@]}"
"${ENV_SET_TRAP_EXIT[@]}"
